...
using GestorUsuariosCRUD.Models;

namespace GestorUsuariosCRUD.Controllers
{
    public class RolesController : Controller
    {
        private readonly GestorBdContext _context;

        public RolesController(GestorBdContext context)
        {
            _context = context;
        }
